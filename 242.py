        ...
        if int(id_region) < 100:
            ...
            for jpg in q1:
                ...
                if not name_id is mas_brak_fon:
                    ...
                    im_v_pechat = Image.open(r'242/в печать/203х305 синий фон.jpg')
                    im_v_pechat_6 = Image.open(r'242/в печать 6/2022 Армия 210x297.jpg')
        ...
        if int(id_region) < 100:
            ...
            for jpg in tqdm(q1):
                ...
                if not name_id is mas_brak_fon:
                    ...
                    im_foto_sh = Image.open(r'242/в печать 11/в печать 1 шаблон.jpg')
                    im_foto_sh1 = Image.open(r'242/в печать 11/1.jpg')
                    im_foto_sh_kamyf = Image.open(r'242/в печать 11/10x15-камуфляж.jpg')
                    im_foto_sh_ykaz = Image.open(r'242/в печать 11/Указ лето22 152х203.jpg')
                    im_foto_sh_ykaz_t = Image.open(r'242/в печать 11/Указ лето22 152х203.png')
                    im_ramka_big = Image.open(r'242/в печать 11/рамка 152х203.png')
                    im_ramka = Image.open(r'242/в печать 12/10x15 рамка.png')
                    im_ykaz_zel = Image.open(r'242/в печать 7/указ-лето2022.jpg')
                    im_vert = Image.open(r'242/в печать 9/210х297 вертолетыАрмия.jpg')
                    im_vert_png = Image.open(r'242/в печать 9/210х297 вертолетыАрмия.png')
                    ...
                    im_ykaz_zel_shablon = Image.open(r'242/в печать 7/указ-лето2022.png')
        ...
        if int(id_region) < 100:
            ...
            for jpg in q1:
                ...
                if not name_id is mas_brak_fon:
                    ...
                    im_big_kal_c = Image.open("242/в печать 15/Calendar_320х620_2022-23год_Шаблон.jpg")
                    ...
                    # водяной знак
                    im_voda = Image.open('242/в печать 15/водяной_биг.png')
                    maxsize = (458, 458)
            ...
            for jpg in q1:
                ...
                if not name_id is mas_brak_fon:
                    ...
                    if name_reg == '016' or name_reg == '16':
                        im_foto_flag = Image.open('242/в печать 12/казань.jpg')
                    elif name_reg == "002" or name_reg == "02":
                        im_foto_flag = Image.open('242/в печать 12/уфа.jpg')
                    else:
                        im_foto_flag = Image.open('242/в печать 12/флаг.jpg')

                    im_foto_flag_dyma = Image.open('242/в печать 12/флаг и дума.jpg')
                    im_foto_sh = Image.open('242/в печать 12/в печать 2 шаблон.jpg')
                    im_ramka = Image.open('242/в печать 12/10x15 рамка.png')
                    im_big = Image.open('242/в печать 12/фон.jpg')
                    im_kal_poster_sh = Image.open('242/в печать 10/календарь 2022-2023.jpg')
                    im_kal_poster = Image.open('242/в печать 10/календарь 2022-2023.png')
                    im_poster_big_sh = Image.open('242/в печать 8/210х297 с окном.jpg')
                    im_poster_big = Image.open('242/в печать 8/210х297 с окном.png')
                    ...
                    # водяной знак флаг
                    im_voda = Image.open('242/в печать 11/водяной .png')
                    maxsize = (355, 355)
        ...
        if int(id_region) < 100:
            ...
            for jpg in q1:
                ...
                if not name_id is mas_brak_fon:
                    ...
                    im_kal_domik = Image.open('242/кал_домик/Calendar-domik.png')
                    im_kal_domik_1 = Image.open('242/кал_домик/Calendar-domik-1.jpg')
        ...
        if int(id_region) < 100:
            ...
            for jpg in q1:
                ...
                if not name_id is mas_brak_fon:
                    ...
                    im_magnit_sh = Image.open('242/магнит/магнит_шаблон.jpg')
                    im_magnit_1 = Image.open('242/магнит/магнит-1.jpg')
                    im_magnit_2 = Image.open('242/магнит/магнит-2.jpg')
                    im_magnit_3 = Image.open('242/магнит/магнит-3.jpg')
                    ...
                    # водяной знак маг
                    im_voda_gor = Image.open('242/магнит/водяной_маг_горизонт.png')
                    im_voda = Image.open('242/в печать 11/водяной .png')
                    im_magnit_1 = im_magnit_1.rotate(-90, expand=True)
                    # 1
                    maxsize = (337, 337)
        ...
        if int(id_region) > 100:
            ...
            for jpg in q1:
                ...
                if not name_id is mas_brak_fon:
                    ...
                    im_v_shablon = Image.open(r'242/ПТК_ППЛС/в печать 12 шаблон.jpg')
                    im_v_shablon_png = Image.open(r'242/ПТК_ППЛС/в печать 12 шаблон.png')
                    im_10x15_shablon = Image.open(r'242/ПТК_ППЛС/10x15.jpg')

                    if int(id_region) == 330:  # Ковров ППЛС
                        im_10x15_ = Image.open(r'242/ПТК_ППЛС/10x15 Ковров ППЛС.jpg')
                        im_poster = Image.open(r'242/ПТК_ППЛС/Постер Ковров ППЛС.jpg')
                        im_kal_pryzinka = Image.open(r'242/ПТК_ППЛС/Календарь Ковров ППЛС.jpg')
                    elif int(id_region) == 512:  # Североморск
                        im_10x15_ = Image.open(r'242/ПТК_ППЛС/10х15 Североморск.jpg')
                        im_poster = Image.open(r'242/ПТК_ППЛС/Постер Североморск Северодвинск.jpg')
                        im_kal_pryzinka = Image.open(r'242/ПТК_ППЛС/Календарь Североморск.jpg')
                    elif int(id_region) == 291:  # Северодвинск
                        im_10x15_ = Image.open(r'242/ПТК_ППЛС/10х15 Северодвинск.jpg')
                        im_poster = Image.open(r'242/ПТК_ППЛС/Постер Североморск Северодвинск.jpg')
                        im_kal_pryzinka = Image.open(r'242/ПТК_ППЛС/Календарь Северодвинск.jpg')
                    elif int(id_region) == 391:  # Калининград ПТК
                        im_10x15_ = Image.open(r'242/ПТК_ППЛС/10х15 Калининград.jpg')
                        im_poster = Image.open(r'242/ПТК_ППЛС/Постер Калининград.jpg')
                        im_kal_pryzinka = Image.open(r'242/ПТК_ППЛС/Календарь Калининград.jpg')
                    else:
                    ...
                    im_203x305_fon = Image.open(r'242/ПТК_ППЛС/в печать 4 (203x305).jpg')
    ...
    for v in mas_ved_v:
        ...
        for jpg in list_id:
            ...
            if int(id_region) < 100:
                ...
                shablon_Z = Image.open("242/ПТК_ППЛС/Бланк.jpg")
                ...
                mag_1 = Image.open(path_mag_1).resize((367, 522))
                ...
                shablon_Z.paste(mag_1, (1141, 798))
...
if __name__ == '__main__':
    ...
    Flg = 0
    print("242__Призыв_ПТК_ППЛС:  версия - 11.10.24")
