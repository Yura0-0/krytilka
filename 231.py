...
pp = {'в печать 15': 'в печать 15', 'в печать 11': 'в печать 11', 'КАЛЕНДАРЬ-': 'КАЛЕНДАРЬ-', 'Магнит': 'Магнит',
      ...
      'Konvert': 'Konvert', 'в печать 6': 'в печать 6', 'ПОСТЕР': 'ПОСТЕР'}
        ...
        if int(id_region) < 100:
            ...
            for jpg in q1:
                ...
                if not name_id is mas_brak_fon:
                    ...
                    im_v_pechat = Image.open(r'231/в печать/203х305 синий фон.jpg')
                    im_v_pechat_6 = Image.open(r'231/в печать 6/2022 Армия 210x297.jpg')
                    ...
                    im_voda = Image.open(r'231/в печать 11/водяной .png')
                    maxsize = (355, 355)
                    im_v_pechat.thumbnail(maxsize, Image.Resampling.LANCZOS)
                    im_v_pechat.paste(im_voda, mask=im_voda)
                    path_out = os.path.join(path_create_papka, ved + "_V", f'{pp["в печать"]}', f'{name_id}.webp')
                    im_v_pechat.save(path_out, dpi=(60, 60))
                    # водяной знак в печать 6
                    im_voda_big = Image.open(r'231/в печать 11/водяной .png')
        ...
        if int(id_region) < 100:
            ...
            for jpg in tqdm(q1):
                ...
                if not name_id is mas_brak_fon:
                    ...
                    im_foto_sh = Image.open(r'231/в печать 11/в печать 1 шаблон.jpg')
                    im_foto_sh1 = Image.open(r'231/в печать 11/1.jpg')
                    im_foto_sh_kamyf = Image.open(r'231/в печать 11/10x15-камуфляж.jpg')
                    im_foto_sh_ykaz = Image.open(r'231/в печать 11/Указ лето22 152х203.jpg')
                    im_foto_sh_ykaz_t = Image.open(r'231/в печать 11/Указ лето22 152х203.png')
                    im_ramka_big = Image.open(r'231/в печать 11/рамка 152х203.png')
                    im_ramka = Image.open(r'231/в печать 12/10x15 рамка.png')
                    im_ykaz_zel = Image.open(r'231/в печать 7/указ-лето2022.jpg')
                    im_vert = Image.open(r'231/в печать 9/210х297 вертолетыАрмия.jpg')
                    im_vert_png = Image.open(r'231/в печать 9/210х297 вертолетыАрмия.png')
                    ...
                    im_ykaz_zel_shablon = Image.open(r'231/в печать 7/указ-лето2022.png')
        ...
        if int(id_region) < 100:
            ...
            for jpg in q1:
                ...
                if not name_id is mas_brak_fon:
                    ...
                    im_big_kal_c = Image.open("231/в печать 15/Calendar_320х620_2022-23год_Шаблон.jpg")
                    ...
                    # водяной знак
                    im_voda = Image.open('231/в печать 15/водяной_биг.png')
                    maxsize = (458, 458)
            ...
            for jpg in q1:
                ...
                if not name_id is mas_brak_fon:
                    ...
                    if name_reg == '016' or name_reg == '16':
                        im_foto_flag = Image.open('231/в печать 12/казань.jpg')
                    elif name_reg == "002" or name_reg == "02":
                        im_foto_flag = Image.open('231/в печать 12/уфа.jpg')
                    else:
                        im_foto_flag = Image.open('231/в печать 12/флаг.jpg')

                    im_foto_flag_dyma = Image.open('231/в печать 12/флаг и дума.jpg')
                    im_foto_sh = Image.open('231/в печать 12/в печать 2 шаблон.jpg')
                    im_ramka = Image.open('231/в печать 12/10x15 рамка.png')
                    im_big = Image.open('231/в печать 12/фон.jpg')
                    im_kal_poster_sh = Image.open('231/в печать 10/календарь 2022-2023.jpg')
                    im_kal_poster = Image.open('231/в печать 10/календарь 2022-2023.png')
                    im_poster_big_sh = Image.open('231/в печать 8/210х297 с окном.jpg')
                    im_poster_big = Image.open('231/в печать 8/210х297 с окном.png')
                    ...
                    # водяной знак флаг
                    im_voda = Image.open('231/в печать 11/водяной .png')
                    maxsize = (355, 355)
                    ...
                    # размер водяной знак
                    im_voda_big = Image.open('231/в печать 11/водяной .png')
                    maxsize = (355, 355)
        ...
        if int(id_region) < 100:
            ...
            for jpg in q1:
                ...
                if not name_id is mas_brak_fon:
                    ...
                    im_kal_domik = Image.open('231/кал_домик/Calendar-domik.png')
                    im_kal_domik_1 = Image.open('231/кал_домик/Calendar-domik-1.jpg')
        ...
        if int(id_region) < 100:
            ...
            for jpg in q1:
                ...
                if not name_id is mas_brak_fon:
                    ...
                    im_magnit_sh = Image.open('231/магнит/магнит_шаблон.jpg')
                    im_magnit_1 = Image.open('231/магнит/магнит-1.jpg')
                    im_magnit_2 = Image.open('231/магнит/магнит-2.jpg')
                    im_magnit_3 = Image.open('231/магнит/магнит-3.jpg')
                    ...
                    im_magnit_2.paste(im2, (500, 30), mask_im2_blur)
                    # правый
                    maxsize = (900, 900)
                    im1.thumbnail(maxsize, Image.Resampling.LANCZOS)
                    mask_im1_blur.thumbnail(maxsize, Image.Resampling.LANCZOS)
...
def ptk_ppls(pix):  # постер 4 кал 12 конверт 1 2 5 календарь
    ...
    for ved in vedomosti:
        ...
        if int(id_region) > 100:
            ...
            for jpg in q1:
                ...
                if not name_id is mas_brak_fon:
                    ...
                    im_v_shablon = Image.open(r'231/ПТК_ППЛС/в печать 12 шаблон.jpg')
                    im_v_shablon_png = Image.open(r'231/ПТК_ППЛС/в печать 12 шаблон.png')
                    im_10x15_shablon = Image.open(r'231/ПТК_ППЛС/10x15.jpg')

                    if int(id_region) == 330:  # Ковров ППЛС
                        im_10x15_ = Image.open(r'231/ПТК_ППЛС/10x15 Ковров ППЛС.jpg')
                        im_poster = Image.open(r'231/ПТК_ППЛС/Постер Ковров ППЛС.jpg')
                        # im_kal_pryzinka = Image.open(r'231/ПТК_ППЛС/Календарь Ковров ППЛС.jpg')
                    elif int(id_region) == 512:  # Североморск
                        im_10x15_ = Image.open(r'231/ПТК_ППЛС/10х15 Североморск.jpg')
                        im_poster = Image.open(r'231/ПТК_ППЛС/Постер Североморск Северодвинск.jpg')
                        # im_kal_pryzinka = Image.open(r'231/ПТК_ППЛС/Календарь Североморск.jpg')
                    elif int(id_region) == 291:  # Северодвинск
                        im_10x15_ = Image.open(r'231/ПТК_ППЛС/10х15 Северодвинск.jpg')
                        im_poster = Image.open(r'231/ПТК_ППЛС/Постер Североморск Северодвинск.jpg')
                        # im_kal_pryzinka = Image.open(r'231/ПТК_ППЛС/Календарь Северодвинск.jpg')
                    elif int(id_region) == 391:  # Калининград ПТК
                        im_10x15_ = Image.open(r'231/ПТК_ППЛС/10х15 Калининград.jpg')
                        im_poster = Image.open(r'231/ПТК_ППЛС/Постер Калининград.jpg')
                        # im_kal_pryzinka = Image.open(r'231/ПТК_ППЛС/Календарь Калининград.jpg')
                    else:
                    ...
                    im_203x305_fon = Image.open(r'231/ПТК_ППЛС/в печать 4 (203x305).jpg')
        ...
        # if int(id_region) > 100:
        #     init(autoreset=True)
        #     print(Fore.GREEN + f'[INFO] Прокрутил №__{ved} - {kol_vo_1}шт.\n')
        #     time.sleep(0.1)
...
if __name__ == '__main__':
    ...
    Flg = 0
    print("231_Призыв_ПТК_ППЛС:  версия - 28.04.23")
